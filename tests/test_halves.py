...
# the split lives beside the measuring now, so the job and the script cannot grow two
# different notions of a half; the artifact rules stayed in the script that writes them
